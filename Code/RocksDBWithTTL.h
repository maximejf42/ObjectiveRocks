...
@interface RocksDBWithTTL : NSObject
...
/**
 ...
 @param ttl The ttl of data in the database. Expired data will be deleted on compaction.
...
@interface RocksDBWithTTL (ColumnFamilies)
...
@interface RocksDBWithTTL (Properties)
...
@interface RocksDBWithTTL (WriteOps)
...
@interface RocksDBWithTTL (MergeOps)
...
@interface RocksDBWithTTL (ReadOps)
...
@interface RocksDBWithTTL (DeleteOps)
...
@interface RocksDBWithTTL (WriteBatch)
...
@interface RocksDBWithTTL (Iterator)
...
@interface RocksDBWithTTL (Snapshot)
...
@interface RocksDBWithTTL (Compaction)
